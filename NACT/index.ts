 ...
 * the peer factories, the framing/reassembly functions, the PeerHost contract — is intentionally not
 * re-exported: they are how NACT works, not what it offers.
 */
...
export type {
  // carrier + address
  Transport, TransportSpec, WSOpt, TCPOpt, UnixOpt, ServerOptBase, HeartbeatOpt, CompressionKind,
